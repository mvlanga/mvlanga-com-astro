			...
			<AnimatePresence>
				{isMenuOpen && (
					<motion.nav
						...
						className="fixed top-2 right-2 left-2 z-30 flex max-h-[calc(100%-1rem)] flex-col gap-10 overflow-y-auto rounded-2xl bg-neutral-300 px-8 py-10 sm:top-5 sm:right-5 sm:left-auto sm:w-72 dark:bg-neutral-900"
						id="main-menu"
					>
