...
openGraphCover: "src/content/projects/skoda-enyaq-coupe/skoda-enyaq-coupe-thumbnail_01.jpg"
---
...
<VideoPlayer client:visible src="/projects/skoda-enyaq-coupe/transition-01.mp4" poster={transitionPoster}
             muted={true}
...
<VideoPlayer client:visible src="/projects/skoda-enyaq-coupe/runthrough.mp4" poster={runthroughPoster} muted={false}
