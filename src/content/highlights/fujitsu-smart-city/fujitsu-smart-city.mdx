...
title: Smart City exhibit at Fujitsu Forum
description: The Smart City exhibit at Fujitsu Forum enabled visitors to understand Fujitsu's solutions, products and technologies through animated stories. Projections on a 150 cm high model city created a unique look that caught the attention of all visitors and ensured a steady incoming flow of new visitors.
customer: Fujitsu
cover: ./fujitsu-smart-city-thumbnail_01.jpg
coverAlt: Example picture of the Smart City exhibit at Fujitsu Forum
coverOnHover: ./fujitsu-smart-city-thumbnail_02.jpg
coverOnHoverAlt: Example picture of the Smart City exhibit at Fujitsu Forum
openGraphCover: "src/content/highlights/fujitsu-smart-city/fujitsu-smart-city-thumbnail_01.jpg"
---
	...
	items={[
		{
			type: "image",
			image: beautyOne,
			alt: "Example picture of the Smart City exhibit at Fujitsu Forum",
		},
		{
			type: "image",
			image: beautyTwo,
...
<MyResponsibilities
	description="Design & animation, interface design, fullstack development"
	responsibilities={[
...
<VideoPlayer
	...
	description="Story 4 - Fujitsu Data-Driven Transformation (Available after a later update digitally, e.g. with VR glasses)"
/>
