...
<VideoPlayer client:visible src="/highlights/cariad-iaa/cariad-iaa-teaser.mp4" poster={teaserPoster}
             muted={false}
             alt="Teaser"/>
...
<VideoPlayer client:visible src="/highlights/cariad-iaa/cariad-iaa-live-sessions.mp4" poster={liveSessionsPoster}
