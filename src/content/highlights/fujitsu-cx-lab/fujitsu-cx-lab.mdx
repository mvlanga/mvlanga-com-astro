...
sortOrder: 3
slug: fujitsu-cx-lab
title: Customer Experience Lab, a new virtual Co-Creation-Platform
...
coverAlt: Example screenshot of the Fujitsu CX Lab Application
coverOnHover: ./fujitsu-cx-lab-thumbnail_02.jpg
coverOnHoverAlt: Example screenshot of the Fujitsu CX Lab Application
openGraphCover: "src/content/highlights/fujitsu-cx-lab/fujitsu-cx-lab-thumbnail_01.jpg"
---
...
<VideoPlayer
	client:visible
	src="/highlights/fujitsu-cx-lab/teaser.mp4"
	poster={teaserPoster}
	alt="Example Transition"
/>

<Prose variant="highlight" additionalClasses="max-w-prose mx-auto">
    ## The origin: Our Smart City exhibit at the Fujitsu Forum

    Explaining products and services in a simplified way using a digital city comes from an idea we had during a
    previous project with Fujitsu. With our Smart City exhibit, we explained services to Fujitsu Forum visitors
	...
	items={[
		{
			type: "image",
			image: beautyOne,
			alt: "Example screenshot of the Fujitsu CX Lab Application",
		},
		{
			type: "image",
			image: beautyTwo,
...
<MyResponsibilities
	description="User journey, interface design, fullstack development."
	responsibilities={[
...
<MediaRow
	items={[
		{
			type: "video",
			src: "/highlights/fujitsu-cx-lab/custom-upload.mp4",
		...
		{
			type: "video",
			src: "/highlights/fujitsu-cx-lab/presentation.mp4",
